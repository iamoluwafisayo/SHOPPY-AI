...
const Chat = ({ chatId, handleDrawerToggle }) => {
  ...
  useEffect(() => {
    ...
    try {
      const response = axios.get(`${BASE_URL}user/chat/${chatId || "new"}`, {
        headers: {
    ...
    >
      ...
      >
        ...
        {searching && (
          ...
          >
            <Chip label="Searching..." color="primary" variant="outlined" />
          </Box>
        )}
      </Box>
...
const Chats = () => {
  ...
  const handleDrawerToggle = () => {
    console.log("clicked on drawer toggle");
  ...
  return (
    <Box component="section">
      ...
      />
      <Chat chatId={chatId} handleDrawerToggle={handleDrawerToggle} />
    </Box>
  );
};
